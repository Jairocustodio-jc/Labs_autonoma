...
(cl:defmethod cl:initialize-instance :after ((m <ArrayXY>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArrayXY)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autlab2-msg:<ArrayXY> is deprecated: use autlab2-msg:ArrayXY instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ArrayXY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autlab2-msg:x-val is deprecated.  Use autlab2-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ArrayXY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autlab2-msg:y-val is deprecated.  Use autlab2-msg:y instead.")
  (y m))
